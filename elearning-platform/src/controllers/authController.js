...
//         res.json({ token, userId: user.user_id, role: user.role, avatarUrl: user.avatarUrl });
//     } catch (error) {
...
// // Thêm phương thức cho admin login nếu cần
// exports.adminLogin = async (req, res) => {
//     // Tương tự như phương thức login ở trên nhưng có thể có thêm các kiểm tra khác cho admin
// };
